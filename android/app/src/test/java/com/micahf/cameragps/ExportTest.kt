    ...
    fun writesFramesAndBlanks() {
        ...
        val frames = listOf(
            Frame(
                ...
                accuracyM = 6f, altM = 181.04, exposureMs = 4_000, note = "the \"bean\"",
            ),
            Frame(rollId = 1, number = 2, takenAt = null),
            Frame(rollId = 1, number = 3, takenAt = 1_790_209_400_000, approximate = true),
        )
        val expected = "roll,frame,taken_at,lat,lon,accuracy_m,alt_m,approximate,exposure_ms,note\r\n" +
            "\"Portra, Chicago\",1,2026-09-23T19:22:26-05:00,41.878100,-87.629800,6,181.0,false,4000,\"the \"\"bean\"\"\"\r\n" +
            "\"Portra, Chicago\",2,,,,,,,,\r\n" +
